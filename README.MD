...
#### 1. 环境要求
- 已安装 [Python 3.12+](https://www.python.org/downloads/)。需要将 Python 添加到路径（`Add Python to PATH`）
...
#### 1. Prerequisites
- [Python 3.12+](https://www.python.org/downloads/) must be installed. Ensure you select `Add Python to PATH` during installation.
